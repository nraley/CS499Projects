...
/**
   Utility class for accessing MIDI and reading and parsing MIDI messages.
         
   <p>To use this class properly you should have installed CoreMIDI4J, as OS X has a few ugly MIDI bugs.
*/
...
public class Midi 
    ...
    private static ArrayList<MidiDeviceWrapper> allDevices;
    // A list of all MIDI Devices for incoming MIDI Data
    private static ArrayList<MidiDeviceWrapper> inDevices;
    // A list of all MIDI Devices for outgoing MIDI Data
    private static ArrayList<MidiDeviceWrapper> outDevices;
    private static HashMap manufacturers = null;
    ...
    private ArrayList<MidiMessage> nextMessages = new ArrayList<MidiMessage>();
    private MidiMessage[] empty = new MidiMessage[0];
    private InReceiver inReceiver = null;
    ...
    static void updateDevices() 
        ...
        try 
            ...
            Class c = Class.forName("uk.co.xfactorylibrarians.coremidi4j.CoreMidiDeviceProvider");
           	java.lang.reflect.Method m = c.getMethod("getMidiDeviceInfo", new Class[0]);
            midiDevices = (MidiDevice.Info[])(m.invoke(new Object[0]));
            } 
        catch (Exception ex) 
            {
    ...
    /**
       Blocks until a message is available, then returns all MIDI Messages, in order, 
       that have not yet been processed.  By calling this, the messages are processed and 
       removed from this queue.  If an InterruptedException occurs, the returned array may be
    ...
    */
    ...
    /**
       ...
       the messages are processed and removed from this queue.  The returned array may be
       empty but it will never be null.
    */
